...
pub enum StateEvent {
    ...
    PenBackground(PenBackgroundEvent),
    PenBlink(PenBlinkEvent),
    PenBold(PenBoldEvent),
    PenFont(PenFontEvent),
    PenForeground(PenForegroundEvent),
    PenItalic(PenItalicEvent),
    PenReverse(PenReverseEvent),
    PenStrike(PenStrikeEvent),
    PenUnderline(PenUnderlineEvent),
